...
![](images/download reference.png){width="236"}
...
![](images/artemis interface.png){width="346"}

![](images/artemis assembly.png){width="631"}

![Try View-\>Overview in the Artemis menu](images/artemis overview.png){width="304"}
...
```         
docker run --rm -it -v $(pwd):$(pwd) sangerpathogens/roary roary -f /Data /home/ubuntu/Data/annotations/*/*.gff
```
